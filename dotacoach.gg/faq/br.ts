...
export default {
	// Headers
	"app.faqs.title": "Perguntas frequentes",

	// Sections
	"app.faqs.popular": "Perguntas mais populares",

	// Application FAQs
	"app.faqs.application": "Aplicação",

	"app.faqs.application.getStarted.question":
		"Como eu começo?",
	"app.faqs.application.getStarted.answer":
		`<p>
			O primeiro passo é adicionar '-gamestateintegration' às suas opções de lançamento do Dota 2. Se você já o adicionou e ainda recebe uma mensagem de aviso, certifique-se de fazer login na sua conta Steam. Um guia sobre como adicionar parâmetros de lançamento do Dota 2 pode ser encontrado <a_GSI>aqui</a_GSI>.
		</p>
		<p>
			Depois disso, você pode personalizar o aplicativo de acordo com suas necessidades. Vá para o menu de configurações no canto superior direito: 
		</p>
		<p>
			<img_settings></img_settings>
		</p>
		<p>
			Em seguida, inicie uma partida para acessar a funcionalidade do jogo do Dota Coach.
		</p>
		<p>
			Durante a fase de seleção de heróis, você obtém estatísticas do jogador e proibições e escolhas recomendadas:
		</p>
		<p>
			<img_hero_selection></img_hero_selection>
		</p>
		<p>
			Depois que os heróis forem selecionados, você pode escolher sua função (carregador/trilha segura, meio, trilha vulnerável, principal ou suporte/suporte dedicado) e os heróis que você espera enfrentar. Com base nisso, o Dota Coach recomendará itens de contador para a fase de laning. Observe que você deve combinar esses itens com os itens recomendados por nossos guias no Dota 2. 
		</p>
		<p>
			<img_items_recommendation></img_items_recommendation>
		</p>
		<p>
			No jogo, os seguintes cronômetros aparecerão para recompra de heróis: 
		</p>
		<p>
			<img_buyback_timers></img_buyback_timers>
		</p>
		<p>
			E o seguinte para Roshan e o Glifo da Fortificação:
		</p>
		<p>
			<img_roshan_timer_active_32></img_roshan_timer_active_32>
		</p>
		<p>
			Se outro os jogadores da sua equipe estão usando o Dota Coach, a ativação dos cronômetros será compartilhada entre a equipe. Então, se você esquecer de ativar um cronômetro, não se preocupe, um colega de equipe pode tê-lo ativado! 
		</p>
		<p>
			Os assinantes recebem treinamento de heróis para todos os 123 heróis, acesso aos melhores cronômetros, anúncios removidos e apoiam o desenvolvimento do aplicativo. A taxa de inscrição é de USD 1,99 por mês.
		</p>
		<p>
			Quer ver o aplicativo em ação e aprender sobre seus recursos? <a_tutorial_video>Assista ao nosso vídeo tutorial</a_tutorial_video>!<br></br> Quer falar com a gente? Não há problema: <a_discord>Join our Discord community server</a_discord>!
		</p>`,
