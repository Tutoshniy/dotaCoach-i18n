	...
	text: {
		...
		subCancel: {
			...
			content: {
				...
				zh: `所有订阅均由 Overwolf 到英语处理。</a><br>如果你想取消订阅、退款或忘记取消，请遵循 OfficaLoverWolf <a class="link-danger" target="_blank" rel="noopener noreferrer" href='https://support.overwolf\.com/en/support/solutions/articlesto english/9000178332-app-subscriptions-faq/'> 常见问题解答。</a>`, // #toBeUpdated
		...
		windowDisable: {
			...
			content: {
				...
				zh: `打开桌面窗口右上角的设置，然后选择 “更改设置”。<br>你可以禁用以下窗口组件：<ul><li>信息框</li><li>所有个人计时器（自己和敌方队伍）</比赛期间的回购计时器示例:li><li>符文倒计</li>时<li>性能追踪器</li><li>字幕窗口</li></ul>`, // #toBeUpdated
