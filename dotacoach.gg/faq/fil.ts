export default {
  ...
  "app.faqs.application.getStarted.answer": `<p>
		...
		<p>
			>Pagkatapos nito, maaari mong ipasadya ang application sa iyong mga pangangailangan. Tumungo sa menu ng mga setting sa kanang sulok sa itaas:
		</p>
		<p>
			<img_settings></img_settings>
		</p>
		<p>
			Pagkatapos ay simulan ang isang tugma upang ma-access ang in-game functionality ng Dota Coach.
		</p>
		<p>
			Sa panahon ng yugto ng pagpili ng bayani makakakuha ka ng mga istatistika ng manlalaro at inirekumendang mga pagbabawal at pagpili:
		</p>
		<p>
			<img_hero_selection></img_hero_selection>
		</p>
		<p>
			Sa sandaling napili ang mga bayani maaari mong piliin ang iyong papel (dala/ligtas na lane, kalagitnaan, offlane, core o soft/hard support) at ang mga bayani na inaasahan mong lane laban. Batay sa Dota Coach na ito ay magrekomenda ng mga counter item para sa laning phase. Tandaan na dapat mong pagsamahin ang mga item na ito gamit ang mga item na inirerekomenda ng aming mga gabay sa Dota 2.
		</p>
		<p>
			<img_items_recommendation></img_items_recommendation>
		</p>
		<p>
			Sa laro ang mga sumusunod na timers ay lilitaw para sa mga buybacks ng bayani:
		</p>
		<p>
			<img_buyback_timers></img_buyback_timers>
		</p>
		<p>
			At ang mga sumusunod para sa Roshan at ang Glyph ng Fortification:
		</p>
		<p>
			<img_roshan_timer_active_32></img_roshan_timer_active_32>
		</p>
		<p>
			Kung iba pang mga Ang mga manlalaro sa iyong koponan ay gumagamit ng Dota Coach, ang activation ng timers ay ibabahagi sa mga koponan. Kaya kung nakalimutan mong i-activate ang isang timer, huwag mag-alala, isang kasamahan sa koponan ay maaaring na-activate ito!
		</p>
		<p>
			Ang mga subscriber ay nakakakuha ng bayani coaching para sa lahat ng 123 bayani, access sa ultimate timers, inalis ang mga ad at sinusuportahan ang pag-unlad ng app. Ang bayad sa subscription ay USD 1.99 bawat buwan.
		</p>
		<p>
  ...
  "app.faqs.application.gameStateIntegration.answer": `<p>
		...
		<p>
			Dapat kang magdagdag ng '-gamestateintegration' bilang parameter ng paglunsad ng Dota 2. Kung wala ito, ang Dota Coach ay hindi gagana!
		</p>
		<p>
  ...
  "app.faqs.application.getBanned.answer": `<p>
		...
		<p>
			Ang Dota Coach app ay binuo sa ibabaw ng Overwolf platform. Ang Overwolf platform ay binuo sa pakikipagtulungan sa Valve at sa koponan ng Dota 2. Ang balbula ay mula noong simula nito ay suportado ang mga pagsisikap ng mga application ng third party upang lumikha ng nilalaman at mga sistema na nagpapabuti sa karanasan ng manlalaro.
		</p>
		<p>
  ...
  "app.faqs.application.languages.answer": `<p>
		...
		<p>
			Mangyaring magkaroon ng kamalayan, na sinusuportahan lamang namin ang isang tiyak na hanay ng mga wika.
		</p>
		<p>
			Kung nawawala ang iyong katutubong wika, ipaalam sa amin o tumulong sa pagsasalin!
		</p>
		<p>
  ...
  "app.faqs.application.money.answer": `<p>
		...
		<p>
			Ang Dota Coach app ay gumagawa ng pera sa pamamagitan ng pagpapakita ng mga ad sa ilang bahagi ng app. 
		</p>
		<p>
  ...
  "app.faqs.timers.start.answer": `<p>
		...
		<div_flex>
			<div_width_40>
				Roshan timer bago i-activate:<br></br>
				<divider></divider>
				<img_roshan_timer_inactive></img_roshan_timer_inactive>
			</div_width_40>
			<div_width_40>
				Roshan timer pagkatapos ng pag-activate:<br></br>
				<divider></divider>
  ...
  "app.faqs.timers.sharing.answer": `<p>
		...
		<p>
			Halimbawa ng buyback timers sa panahon ng isang tugma:
		</p>
		<p>
			<img_buyback_timers></img_buyback_timers>
		</p>
		<p>
			Ang resultang post sa team chat:
		</p>
		<p>
  ...
  "app.faqs.timers.disable.answer": `<p>
		...
		<p>
			Maaari mong ang mga bahagi ng timers na hindi mo nais na makita.
		</p>
		<p>
  ...
  "app.faqs.timers.missing.answer": `<p>
		...
		<p>
			Kung ang Dota 2 game coordinator ay hindi natagpuan, ang Dota Coach ay hindi makakakuha ng anumang Data sa tugma na magreresulta sa walang timers.
		</p>
	 	<p>
			Ang isa pang dahilan ay ang nawawalang parameter ng paglunsad '-gamestateintegration'. Siguraduhin na ito ay idinagdag.
		</p>
		<p>
			Suriin ang aming FAQ kung paano idagdag ito. Minsan, ang mga timers ay maaaring pumunta nawawala sa panahon ng repositon. Pindutin lamang ang pindutan ng 'reset' sa window ng mga setting. 
		</p>
		<p>
  ...
  "app.faqs.timers.ultimate.answer": `<p>
		...
		<p>
			Ang isang subscription ay 1.99$/buwan. Buksan ang menu ng application at mag-click sa pamahalaan ang subscription.
		</p>
		<p>
  ...
  "app.faqs.gameModes.trounament.answer": `<p>
		...
		<p>
			Ang mga opisyal na laro ay nagpapadala ng data ng pagsasama ng gamestateintegration na naantala, na nagreresulta sa mga naantalang timers at masamang pag-andar ng app.
		</p>
		<p>
  ...
  "app.faqs.audio.enable.answer": `<p>
		...
		<p>
			Maaari mong mahanap ang kontrol ng tunog output sa kanang sulok sa itaas ng window ng mga setting. Tiyaking piliin ang tamang speaker (audio-output) at ang lakas ng tunog ay hindi zero porsiyento.
		</p>
		<p>
  ...
  "app.faqs.audio.volume.answer": `<p>
		...
		<p>
			Maaari mong mahanap ang kontrol ng pagsasaayos ng lakas ng tunog sa kanang sulok sa itaas ng window ng mga setting.
		</p>
		<p>
			<img_settings_audio></img_settings_audio>
		</p>`,
  ...
  "app.faqs.audio.disable.answer": `<p>
		...
		<p>
			Maaari mong hindi paganahin ang mga sumusunod na bahagi ng boses nang paisa-isa:
		</p>
		<ul>
			<li>Mga Abiso</li>
			<li>Voice coaching sariling bayani</li>
  ...
  "app.faqs.windows.secondScreen.answer": `<p>
		...
		<p>
			Piliin ang iyong pangalawang o pangunahing monitor upang paganahin ang window.
		</p>
		<p>
  ...
  "app.faqs.windows.reposition.answer": `<p>
		...
		<p>
			Isaaktibo ang slider ng Reposition sa kanang sulok sa ibaba ng window ng mga setting. I-de-activate ang slider ng Reposition kapag tapos ka na upang ligtas ang iyong mga bagong posisyon.
		</p>
		<p>
  ...
  "app.faqs.windows.green.answer": `<p>
		...
		<p>
			I-de-activate ang slider ng Reposition sa kanang sulok sa ibaba ng window ng mga setting.
		</p>
		<p>
			<img_settings_reposition></img_settings_reposition>
		</p>`,
  ...
  "app.faqs.windows.showHide.answer": `<p>
		...
		<p>
			Ang karaniwang hotkey ay 'CTRL + b'.
		</p>
		<p>
			Kung nais mong baguhin ang hotkey, magtungo sa mga setting ng overwolf app.
		</p>
		<p>
  ...
  "app.faqs.windows.missing.answer": `<p>
		...
		<ul>
			...
			<li>
				Ang isa pang dahilan ay ang nawawalang parameter ng paglunsad '-gamestateintegration'. Siguraduhin na ito ay idinagdag. Suriin ang aming FAQ kung paano idagdag ito.
			</li>
			<li>
				Minsan, ang mga timers ay maaaring pumunta nawawala sa panahon ng repositon. Pindutin lamang ang pindutan ng 'reset' sa window ng mga setting.<br></br>
				<img_reset_position></img_reset_position>
			</li>
		</ul>`,
  ...
  "app.faqs.windows.disable.answer": `<p>
		...
		<p>
			Maaari mong hindi paganahin ang mga sumusunod na bahagi ng window:
		</p>
		<ul>
			<li>Infoboxes Lahat ng mga</li>
			<li>indibidwal na timers (Sariling at kaaway koponan)</li>
			<li>Rune Countdowns</li>
			<li>Pagganap Tagasubaybay</li>
  ...
  "app.faqs.hotkeys.change.answer": `<p>
		...
		<ul>
			<li>I-right-click ang simbolo ng overwolf sa iyong taskbar.</li>
			<li>Piliin ang mga setting.</li>
			<li>Piliin ang Overlay & Hotkeys sa kaliwang sulok sa itaas.</li>
			<li>Piliin ang Dota 2 bilang laro.</li>
			<li>Pumunta sa Seksyon ng Dota Coach.</li>
			<li>Baguhin ang mga hotkey sa iyong mga pangangailangan..</li>
		</ul>
		<p>
  ...
  "app.faqs.hotkeys.misclick.answer": `<p>
		...
		<p>
			Buksan ang mga setting sa kanang itaas na sulok ng window ng desktop at piliin ang 'baguhin ang mga setting. ' Makikita mo ang “Mouse Click Mouse Modifier' na Key sa kanang sulok sa itaas ng window ng mga setting.
		</p>
		<p>
			Mangyaring tandaan na kung pipiliin mo ang 'shift' o 'ctrl' bilang modifier, ang pagpapahayag ng mga timers sa chat ay hindi na gagana.
		</p>
		<p>
  ...
  "app.faqs.streaming.windows.answer": `<p>
		...
		<p>
			Kung ang ilan sa mga window ng app ay nawawala sa iyong stream, dapat mong subukan ang sumusunod:
		</p>
		<ul>
			<li>Kunin ang Dota2 window na may game capture (right click Source -> Add -> Gamecapture)</li>
  ...
  "app.faqs.account.login.answer": `<p>
		...
		<p>
			Ang parehong mga pag-login ay matatagpuan sa kanang sulok sa itaas ng kanilang mga bintana.
		</p>
		<p>
			I-click lamang ang logo ng overwolf upang buksan ang dialog ng pag-login.
		</p>
		<p>
  ...
  "app.faqs.account.logout.answer": `<p>
		...
		<p>
			Ang parehong mga logout ay matatagpuan sa kanang sulok sa itaas ng kanilang mga bintana. I-click lamang ang logo ng overwolf upang buksan ang dialog ng logout.
		</p>
		<p>
			<img_loginout></img_loginout>
		</p>`,
  ...
  "app.faqs.account.manage.answer": `<p>
		...
		<p>
			Mag-click sa logo ng overwolf sa kanang sulok sa itaas.
		</p>
		<p>
  ...
  "app.faqs.subscription.features.answer": `<p>
		...
		<ul>
			<li>Voice coaching para sa lahat ng mga bayani Dota 2 ay dapat mag-alok.</li>
			<li>Adjustable Ultimate timers para sa kaaway at ang iyong koponan.</li>
			<li>Magdagdag ng libreng Dota Coach karanasan.</li>
  ...
  "app.faqs.subscription.payment.answer": `<p>
		...
		<p>
			Pinaka-popular na paraan ng pagbabayad:
		</p>
		<ul>
  ...
  "app.faqs.subscription.proCoach.answer": `<p>
		...
		<ul>
			<li>Buksan ang Overwolf Desktop Client.</li>
			<li>Mag-click sa 'Library'.</li>
			<li>Mag-click sa pindutan ng maliit na setting sa tabi ng logo ng Dota Coach.</li>
			<li>Mag-click sa 'view sa appstore'</li><li>I-click ang 'Mag-subscribe' sa loob ng bagong window.</li>
			<li>Sundin ang mga na-promote na hakbang.</li>
		</ul>
		<p>
			Tingnan din ang FAQ ng <a_overwolf_subscription>Overwolf FAQ</a_overwolf_subscription> kung paano mag-subscribe sa apps..
		</p>
		<p>
  ...
  "app.faqs.issues.bug.answer": `<p>
		...
		<p>
			Kung kailangan mo ng karagdagang tulong, mangyaring sumali sa aming <a_discord>Discord</a_discord> server!
		</p>
		<p>
  ...
  "app.faqs.issues.fps.answer": `<p>
		...
		<p>
			Ang pag-tab (Alt+Tab) sa pagitan ng iyong desktop at Dota 2 ay magdudulot din ng mga problema sa overtime ng frame rate. Kung mangyari ito, i-restart ang Dota 2.
		</p>
		<p>
			Ang display ng mensahe ng notification ng singaw ay nagdudulot din ng mga problema sa frame rate. Maaari mo itong i-disable dito:
		</p>
		<ul>
			<li>Buksan ang iyong listahan ng kaibigan (I-right click ang steam sa taskbar -> mga kaibigan).</li>
			<li>Mag-click sa mga setting ng gulong sa kanang sulok sa itaas.</li>
			<li>Huwag paganahin ang lahat ng mga notification tulad ng ipinapakita sa larawan sa ibaba.</li>
		</ul>
		<p>
  ...
  "app.faqs.heroGuides.get.answer": `<p>
		...
		<p>
			Mag-subscribe sa kanila <a_dota_guides>dito</a_dota_guides>.
		</p>
		<p>
			Pumili ng isang bayani at mag-click sa 'Kumuha ng Steam Guide ':
		</p>
		<ul>
			<li>Mag-scroll pababa hanggang makita mo ang berdeng button na 'Mag-subscribe'.</li>
			<li>I-click ang 'Mag-subscribe' sa pahina ng Steam.</li>
			<li>Kung hindi ka pa naka-log in, mangyaring mag-log in sa Steam.</li>
			<li>Ang pag-login ay kinakailangan lamang sa unang pagkakataon.</li>
			<li>I-click ang 'Paboritong' sa pahina ng Steam - gagawin nito ang gabay na lumitaw sa ibabaw ng iyong listahan ng mga gabay sa laro I-click ang</li>
			<li>'Thumbs Up 'upang gawing mas nakikita ang gabay sa iba pang mga gumagamit - opsyonal, ngunit pinahahalagahan! </li>
			<li>Ulitin ang proseso para sa lahat ng mga bayani na gusto mong i-play.</li>
			<li>Kailangan mong i-restart ang Dota upang makita ang iyong mga napiling gabay sa laro!</li>
		</ul>
  ...
  "app.faqs.heroGuides.missing.answer": `<p>
		...
		<p>
			Maaari kang sumali sa lobby ng 'Demo Hero' at tingnan kung maayos ang mga gabay.
		</p>
		<p>
			Mahalaga na piliin mo ang mga ito sa laro sa interface ng tindahan pagkatapos mong mag-subscribe sa kanila. 
		</p>
		<p>
