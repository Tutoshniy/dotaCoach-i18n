export default {
  ...
  "app.faqs.application.getStarted.answer": `<p>
		...
		<p>
			Setelah itu, Anda dapat menyesuaikan aplikasi dengan kebutuhan Anda. Buka menu pengaturan di pojok kanan atas:
		</p>
		<p>
			<img_settings></img_settings>
		</p>
		<p>
			Kemudian mulailah kecocokan untuk mengakses fungsionalitas dalam game Dota Coach.
		</p>
		<p>
			Selama fase pemilihan pahlawan Anda mendapatkan statistik pemain dan larangan dan picks yang direkomendasikan:
		</p>
		<p>
			<img_hero_selection></img_hero_selection>
		</p>
		<p>
			Setelah pahlawan dipilih, Anda dapat memilih peran Anda (jalur bawa/aman, pertengahan, offlane, inti atau dukungan lembut/keras) dan pahlawan yang Anda harapkan untuk jalur melawan. Berdasarkan Dota Coach ini akan merekomendasikan item counter untuk fase laning. Perhatikan bahwa Anda harus menggabungkan item ini dengan item yang direkomendasikan oleh panduan kami di Dota 2.
		</p>
		<p>
			<img_items_recommendation></img_items_recommendation>
		</p>
		<p>
			Dalam permainan timer berikut akan menangkap untuk buyback pahlawan:
		</p>
		<p>
			<img_buyback_timers></img_buyback_timers>
		</p>
		<p>
			Dan berikut untuk Roshan dan Glyph of Fortification:
		</p>
		<p>
			<img_roshan_timer_active_32></img_roshan_timer_active_32>
		</p>
		<p>
			Jika lain pemain dalam tim Anda menggunakan Dota Coach, aktivasi timer akan dibagi di antara tim. Jadi jika Anda lupa untuk mengaktifkan timer, jangan khawatir, rekan satu tim mungkin telah mengaktifkannya!
		</p>
		<p>
			Pelanggan mendapatkan pelatihan pahlawan untuk semua 123 pahlawan, akses ke timer utama, iklan dihapus dan mendukung pengembangan aplikasi. Biaya langganan adalah USD 1.99 per bulan. 
		</p>
		<p>
  ...
  "app.faqs.application.gameStateIntegration.answer": `<p>
		...
		<p>
			Anda harus menambahkan '-gamestateintegration' sebagai parameter peluncuran Dota 2. Tanpa itu, Dota Coach tidak akan bekerja!
		</p>
		<p>
  ...
  "app.faqs.application.getBanned.answer": `<p>
		...
		<p>
			Aplikasi Dota Coach dibangun di atas platform Overwolf. Platform Overwolf dibangun bekerja sama dengan Valve dan tim Dota 2. Valve sejak awal mendukung upaya aplikasi pihak ketiga untuk membuat konten dan sistem yang meningkatkan pengalaman pemain.
		</p>
		<p>
  ...
  "app.faqs.application.languages.answer": `<p>
		...
		<p>
			Perlu diketahui, bahwa kami hanya mendukung satu set bahasa tertentu.
		</p>
		<p>
			Jika bahasa ibu Anda hilang, beri tahu kami atau bantu terjemahannya!
		</p>
		<p>
  ...
  "app.faqs.application.money.answer": `<p>
		...
		<p>
			Aplikasi Dota Coach menghasilkan uang melalui menampilkan iklan di beberapa bagian aplikasi. 
		</p>
		<p>
  ...
  "app.faqs.timers.start.answer": `<p>
		...
		<div_flex>
			<div_width_40>
				Timer Roshan sebelum aktivasi:<br></br>
				<divider></divider>
				<img_roshan_timer_inactive></img_roshan_timer_inactive>
			</div_width_40>
			<div_width_40>
				Roshan setelah aktivasi:<br></br>
				<divider></divider>
  ...
  "app.faqs.timers.sharing.answer": `<p>
		...
		<p>
			Contoh penghitung waktu buyback selama pertandingan:
		</p>
		<p>
			<img_buyback_timers></img_buyback_timers>
		</p>
		<p>
			Menghasilkan postingan pada obrolan tim:
		</p>
		<p>
  ...
  "app.faqs.timers.disable.answer": `<p>
		...
		<p>
			Anda dapat timer komponen yang Anda tidak ingin melihat.
		</p>
		<p>
  ...
  "app.faqs.timers.missing.answer": `<p>
		...
		<p>
			Jika koordinator permainan Dota 2 tidak ditemukan, Dota Coach tidak mendapatkan Data apa pun pada pertandingan yang akan menghasilkan tanpa timer.
		</p>
	 	<p>
			Alasan lain adalah hilangparameter launchparameter '-gamestateintegration'. Pastikan bahwa itu ditambahkan. Periksa FAQ kami tentang cara menambahkannya.
		</p>
		<p>
			Kadang-kadang, timer bisa hilang selama repositon. Cukup tekan tombol 'reset' di jendela pengaturan.
		</p>
		<p>
  ...
  "app.faqs.timers.ultimate.answer": `<p>
		...
		<p>
			Langganan adalah 1.99$ /bulan. Buka menu aplikasi dan klik kelola langganan.
		</p>
		<p>
  ...
  "app.faqs.gameModes.trounament.answer": `<p>
		...
		<p>
			Game resmi mengirim data gamestateintegrasi tertunda, yang menghasilkan timer tertunda dan fungsionalitas aplikasi yang buruk.
		</p>
		<p>
  ...
  "app.faqs.audio.enable.answer": `<p>
		...
		<p>
			Anda dapat menemukan kontrol output suara di sudut kanan atas jendela pengaturan. Pastikan untuk memilih speaker yang tepat (audio-output) dan bahwa volume tidak nol persen.
		</p>
		<p>
  ...
  "app.faqs.audio.volume.answer": `<p>
		...
		<p>
			Anda dapat menemukan kontrol penyesuaian volume di sudut kanan atas jendela pengaturan.
		</p>
		<p>
			<img_settings_audio></img_settings_audio>
		</p>`,
  ...
  "app.faqs.audio.disable.answer": `<p>
		...
		<p>
			Anda dapat menonaktifkan komponen suara berikut secara individual:
		</p>
		<ul>
			<li>Pemberitahuan</li>
			<li>Pelatih suara pahlawan sendiri Pahlawan</li>
  ...
  "app.faqs.windows.secondScreen.answer": `<p>
		...
		<p>
			Pilih monitor kedua atau utama Anda untuk mengaktifkan jendela.
		</p>
		<p>
  ...
  "app.faqs.windows.reposition.answer": `<p>
		...
		<p>
			Aktifkan slider Reposisi di sudut kanan bawah jendela pengaturan. De-aktifkan slider Reposisi setelah Anda selesai untuk mengamankan posisi baru Anda.
		</p>
		<p>
  ...
  "app.faqs.windows.green.answer": `<p>
		...
		<p>
			De-aktifkan slider Reposisi di sudut kanan bawah jendela pengaturan.
		</p>
		<p>
			<img_settings_reposition></img_settings_reposition>
		</p>`,
  ...
  "app.faqs.windows.missing.answer": `<p>
		...
		<ul>
			...
			<li>
				Alasan lain adalah hilangparameter launchparameter '-gamestateintegration'.
			</li>
			<li>
				Pastikan bahwa itu ditambahkan. Periksa FAQ kami tentang cara menambahkannya. Kadang-kadang, timer bisa hilang selama repositon. Cukup tekan tombol 'reset' di jendela pengaturan. <br></br>
				<img_reset_position></img_reset_position>
			</li>
		</ul>`,
  ...
  "app.faqs.windows.disable.answer": `<p>
		...
		<p>
			Anda dapat menonaktifkan komponen jendela berikut:
		</p>
		<ul>
			<li>Infoboxes</li>
			<li>Semua timer individu (Sendiri dan tim musuh)</li>
			<li>Rune Countdown</li>
			<li>Kinerja Tracker</li>
  ...
  "app.faqs.hotkeys.change.answer": `<p>
		...
		<ul>
			<li>Klik kanan simbol overwolf di taskbar Anda.</li>
			<li>Pilih pengaturan.</li>
			<li>ilih Overlay & Hotkeys di pojok kiri atas.</li>
			<li>Pilih Dota 2 sebagai permainan.</li>
			<li>Pergi ke Bagian Pelatih Dota.</li>
			<li>Ubah hotkeys sesuai kebutuhan Anda.</li>
		</ul>
		<p>
  ...
  "app.faqs.hotkeys.misclick.answer": `<p>
		...
		<p>
			Buka pengaturan di sudut kanan atas jendela desktop dan pilih 'perubahan pengaturan'. Anda dapat menemukan 'Mouse Click Modifier' Key di sudut kanan atas jendela pengaturan.
		</p>
		<p>
			Harap dicatat bahwa jika Anda memilih 'shift' atau 'ctrl' sebagai pengubah, mengumumkan timer dalam obrolan tidak akan berfungsi lagi.
		</p>
		<p>
  ...
  "app.faqs.streaming.windows.answer": `<p>
		...
		<p>
			Jika beberapa jendela aplikasi tidak ada di streaming Anda, Anda harus mencoba yang berikut ini:
		</p>
		<ul>
			<li>Dapatkan jendela Dota2 dengan pengambilan game (klik kanan Sumber -> Tambah -> Gamecapture)</li>
  ...
  "app.faqs.account.login.answer": `<p>
		...
		<p>
			Kedua login terletak di sudut kanan atas jendela mereka.
		</p>
		<p>
			Cukup klik logo overwolf untuk membuka dialog login.
		</p>
		<p>
  ...
  "app.faqs.account.logout.answer": `<p>
		...
		<p>
			Kedua logout terletak di sudut kanan atas jendela mereka. Cukup klik logo overwolf untuk membuka dialog logout. 
		</p>
		<p>
			<img_loginout></img_loginout>
		</p>`,
  ...
  "app.faqs.account.manage.answer": `<p>
		...
		<p>
			Klik pada logo overwolf di pojok kanan atas.
		</p>
		<p>
  ...
  "app.faqs.subscription.features.answer": `<p>
		...
		<ul>
			<li>Pelatihan suara untuk semua pahlawan yang ditawarkan Dota 2.</li>
			<li>Timer Ultimate yang dapat disesuaikan untuk musuh dan tim Anda.</li>
			<li>Tambahkan pengalaman Dota Coach gratis.</li>
  ...
  "app.faqs.subscription.proCoach.answer": `<p>
		...
		<ul>
			<li>Buka Overwolf Desktop Client.</li>
			<li>Klik 'Perpustakaan'.</li>
			<li>Klik pada tombol pengaturan kecil di sebelah logo Dota Coach.</li>
			<li>Klik 'lihat di appstore' Klik.</li>
			<li>Berlangganan' di dalam jendela baru.</li>
			<li>Ikuti langkah-langkah yang dipromosikan.</li>
		</ul>
		<p>
			Lihat juga FAQ <a_overwolf_subscription>Overwolf FAQ</a_overwolf_subscription> tentang cara berlangganan aplikasi.
		</p>
		<p>
  ...
  "app.faqs.issues.bug.answer": `<p>
		...
		<p>
			Jika Anda memerlukan bantuan lebih lanjut, silakan bergabung dengan server  <a_discord>Discord</a_discord> kami!
		</p>
		<p>
  ...
  "app.faqs.issues.fps.answer": `<p>
		...
		<p>
			Tabbing (Alt+Tab) di antara desktop Anda dan Dota 2 juga akan menyebabkan masalah frame rate lembur. Jika ini terjadi, restart Dota 2.
		</p>
		<p>
			Tampilan pesan notifaction uap juga menyebabkan masalah frame rate. Anda dapat menonaktifkannya di sini:
		</p>
		<ul>
			<li>Buka daftar frind Anda (Klik kanan uap di taskbar -> teman).</li>
			<li>Llick pada roda pengaturan di sudut kanan atas.</li>
			<li>Nonaktifkan semua notifactions seperti yang ditunjukkan pada gambar di bawah ini.</li>
		</ul>
		<p>
  ...
  "app.faqs.heroGuides.get.answer": `<p>
		...
		<p>
			Berlangganan mereka <a_dota_guides>>di sini</a_dota_guides>.
		</p>
		<p>
			Pilih pahlawan dan klik 'Get Steam Guide':
		</p>
		<ul>
			<li>Gulir ke bawah sampai Anda melihat tombol hijau 'Berlangganan'.</li>
			<li>Klik 'Berlangganan' pada halaman Uap.</li>
			<li>Jika Anda belum login, silakan masuk ke Steam.</li>
			<li>Login hanya diperlukan untuk pertama kalinya.</li>
			<li>Klik 'Favorit' di halaman Uap - ini akan membuat panduan muncul di atas daftar panduan Anda dalam permainan</li>
			<li>Klik 'Thumbs Up' untuk membuat panduan lebih terlihat oleh pengguna lain - opsional, tapi dihargai!</li>
			<li>Ulangi proses untuk semua pahlawan yang ingin Anda mainkan.</li>
			<li>Anda harus me-restart Dota untuk melihat panduan yang Anda pilih dalam permainan!</li>
		</ul>
  ...
  "app.faqs.heroGuides.missing.answer": `<p>
		...
		<p>
			Anda dapat bergabung dengan lobi 'Demo Hero' dan memeriksa apakah panduan telah dimuat dengan benar.
		</p>
		<p>
			Adalah penting bahwa Anda memilih mereka dalam game di antarmuka toko setelah Anda berlangganan mereka.
		</p>
		<p>
