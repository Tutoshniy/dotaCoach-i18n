export default {
  ...
  GameStateIntegrationTypo: {
    ...
    fr: "Il y a une faute de frappe dans tes options de lancement Dota 2 pour Game State Integration. Remplace « {typo} » par « -gamestateintegration ».",
    ru: "В параметрах запуска Dota 2 для интеграции состояния игры допущена опечатка. Замените «{typo}» на «-gamestateintegration».",
    id: "Ada kesalahan ketik di opsi peluncuran Dota 2 Anda untuk Integrasi Status Game. Harapganti ''{typo}'' dengan '-gamestateintegration'.", // #toBeUpdated
    fil: "Mayroong typo sa iyong mga pagpipilian sa paglunsad ng Dota 2 para sa Pagsasama ng Estado ng Game. Mangyaringpalitan ang ''{typo}'' ng 'gamestateintegration'.", // #toBeUpdated
    zh: "你的 Dota 2 游戏状态集成的启动选项中有一个错字。请将 “{typo}” 替换为 '-gamestateIntegrategrate'。", // #toBeUpdated
    br: "Há um erro de digitação nas opções de lançamento do Dota 2 para a Integração do Estado do Jogo. Substitua ''{typo}'' por '-gamestateintegration'.",
    es: "Hay un error tipográfico en las opciones de lanzamiento de Dota 2 para la integración del estado del juego. Reemplaza ''{typo}'' por '-gamestateintegration'.", // #toBeUpdated
  },
