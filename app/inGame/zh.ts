export default {
  ...
  YouWon4Games: "你连续赢了 4 场比赛",
  MateWon4Games: "{playerName} 在你的队伍中连续赢了 4 场比赛",
  EnemyWon4Game: "{playerName} 在敌方队伍中连续赢了 4 场比赛",
  YouHighWinRate: "在最后一场 {matchCount} 场比赛中，你的胜率高达 {winRate}%",
  MateHighWinRate: "你队伍中的 {playerName} 在过去 {matchCount} 场比赛中有 {winRate}% 的高胜率",
  EnemyHighWinRate:
    "敌方队伍中的 {playerName} 在最后 {matchCount} 场比赛中获得 {winRate}% 的高胜率",
  EnemyLowWinRate: "敌方队伍中的 {playerName} 获胜率较低且经常挑选英雄",

  PlayerIsSmurf:
    "With a win rate of {winRate}% over the last {matchCount} matches likely to be a smurf.",

  WinningLosingStreaks: "正在连胜或者连败",
  ...
  CounteItemsConsider: "可以考虑针对使用的物品（对线期）",
